...
source_mobileperf_folder = "/Users/yangcong/PycharmProjects/Perf/mobileperf-master"  # MobilePerf源文件夹路径
# 打印每个设备的 ID 并执行相应操作
for device_line in device_lines:
    ...
    if "device" in device_line:
        ...
        sh_directory = f"/Users/yangcong/PycharmProjects/Perf/R/_{device_id}"
        sh_file = f"run.sh"
        # 进入 sh 文件所在目录
