...
class DatabaseOperations:
    ...
    def CPU_info_insert(self, cpu_data):
        ...
        try:
            cur.execute("""
                INSERT INTO cpu_info (device_id, datetime, device_cpu_rate, user_rate, system_rate, idle_rate, package_name, pid, pid_cpu_rate, recorded_at)
